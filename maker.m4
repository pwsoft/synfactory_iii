...
* $1
**********************************************************************/])
define([sysinclude], [ifdef([__sysincludes_$1],x,[define([__sysincludes_$1],)MacroBack([__sysincludes],[[#include <$1>]])])])
...
define([vars], [MacroBack]([[__vars]],[[[$1]]]))
#
...
define([code1], [MacroBack]([[__code1]],[[#]line __line__ "__file__"]
[[$1]]))
define([code2], [MacroBack]([[__code2]],[[#]line __line__ "__file__"]
[[$1]]))
define([code3], [MacroBack]([[__code3]],[[#]line __line__ "__file__"]
[[$1]]))
define([module],)
divert[]dnl
